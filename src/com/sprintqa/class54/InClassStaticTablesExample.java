...
class InClassStaticTablesExample {
	...
	/**
	 * Go to: https://the-internet.herokuapp.com/tables 1. Use the browser to Locate
	 * the Locator you need to use to find the table headers for the table in
	 * Example1. 2. Write out the number of columns using the Collector size()
	 * method. 3. Loop through the TH tags in Row 1 and write out the table headers
	 * to the console. 4. Use the browser to Locate the Locator you need to use to
	 * find the table body rows. 5. Write out the number of rows using the Collector
	 * size() method. 6. Convert the List to an Iterator using the List iterator()
	 * method 7. Loop through the Iterator Collection using the Iterator hasNext()
	 * method 8. Using the Iterator next() method to get the next WebElement in the
	 * collection. 9. Then use the WebElement getText method to get the rowText. 10.
	 * Finally, write the rowText to the console using System.out.
	 * 
	 * @throws InterruptedException
	 */
	@Test
	void inClassStaticTablesTEST() throws InterruptedException {
